...
var TelnetDriver = (_dec = (0, _named.Named)("IP_PORT"), _dec(_class = /*#__PURE__*/function () {
  function TelnetDriver() {
    _classCallCheck(this, TelnetDriver);
  }

  _createClass(TelnetDriver, [{
    key: "execute",
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  connection = new _telnetClient.Telnet(); // these parameters are just examples and most probably won't work for your use-case.
