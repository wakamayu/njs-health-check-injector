...
exports.DriverSingleton = void 0;
...
var DriverSingleton = /*#__PURE__*/function () {
  /**
   * The DriverSingleton's constructor should always be private to prevent direct
   * construction calls with the `new` operator.
   */
  function DriverSingleton() {
    _classCallCheck(this, DriverSingleton);
  ...
  _createClass(DriverSingleton, [{
    key: "initialize",
    value: function () {
      var _initialize = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var folder, files, index, driverImport, named;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this._drivers = new Map();
                folder = "".concat(__dirname, "/../driver");
                files = (0, _fs.readdirSync)(folder);
                index = 0;
              ...
              case 4:
                ...
                driverImport = "".concat(folder, "/").concat(files[index]);
                _context.next = 8;
                return Promise.resolve("".concat(driverImport)).then(function (s) {
                  return _interopRequireWildcard(require(s));
                });

              case 8:
                named = _context.sent["default"];

                if (named instanceof _named.AnnotadtedNamed) {
...
exports.DriverSingleton = DriverSingleton;